    ...
    <nav class="nav">
      ...
      <el-badge :value="questions.length" class="item">
        <el-button style="margin-left: 10px" type="primary" v-on:click="toFinder()"
          ><i class="el-icon-right" />Vorschau</el-button
        >
      </el-badge>
      <el-button style="margin-left: 10px; background: white; box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06);" icon="el-icon-download
"></el-button>
    </nav>
